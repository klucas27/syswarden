...
#
# Moderate risk — headless / no-GUI, long-running services.
# cpu_weight + io_weight + memory_high for fair scheduling under load.
#
# Risk level : Moderate
# Actions    : SetCpuWeight, SetIoWeight, SetMemoryHigh
#
# Usage: sudo ./scripts/profiles/activate-server.sh
...
# syswarden — server profile
# Moderate risk: cpu_weight + io_weight + memory_high for headless workloads.
...
restart_or_enable "server"
first_cleanup "server"
profile_summary "server"
